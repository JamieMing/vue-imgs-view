<template>
	<scroller>
		<div style="padding:20px;">
			...
			<div class="descript">An image viewer base on Vue.js for mobile</div>
	...
	data() {
		return {
			...
			list1: [
				{
					src:
						"https://zhiling-open.oss-cn-shenzhen.aliyuncs.com//park1/20190111105326515_3881087860_315_405_convenience.png"
				},
				{
					src:
